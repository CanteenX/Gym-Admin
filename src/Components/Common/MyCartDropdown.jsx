...
const MyCartDropdown = () => {
    ...
    const removeItem = (ele) => {
        const price = ele.closest(".dropdown-item-cart").querySelector('.cart-item-price').innerHTML;
            ...
            <DropdownMenu className="dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart"
                ...
                <SimpleBar style={{ maxHeight: "300px" }}>
                    <div className="p-2">
                        ...
                        {cartData.map((item) => (<div className="d-block dropdown-item text-wrap dropdown-item-cart px-3 py-2" key={item.id}>
