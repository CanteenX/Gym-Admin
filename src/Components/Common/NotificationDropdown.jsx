                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="px-2 fs-15">
                                        <div className="form-check notification-check">
                                            ...
                                            <label className="form-check-label" htmlFor="all-notification-check01"><span className="visually-hidden">Select notification</span></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="px-2 fs-15">
                                        <div className="form-check notification-check">
                                            ...
                                            <label className="form-check-label" htmlFor="all-notification-check02"><span className="visually-hidden">Select notification</span></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="px-2 fs-15">
                                        <div className="form-check notification-check">
                                            ...
                                            <label className="form-check-label" htmlFor="all-notification-check03"><span className="visually-hidden">Select notification</span></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="px-2 fs-15">
                                        <div className="form-check notification-check">
                                            ...
                                            <label className="form-check-label" htmlFor="all-notification-check04"><span className="visually-hidden">Select notification</span></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="px-2 fs-15">
                                            <div className="form-check notification-check">
                                                ...
                                                <label className="form-check-label" htmlFor="messages-notification-check01"><span className="visually-hidden">Select message notification</span></label>
                                            </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="px-2 fs-15">
                                            <div className="form-check notification-check">
                                                ...
                                                <label className="form-check-label" htmlFor="messages-notification-check02"><span className="visually-hidden">Select message notification</span></label>
                                            </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="px-2 fs-15">
                                            <div className="form-check notification-check">
                                                ...
                                                <label className="form-check-label" htmlFor="messages-notification-check03"><span className="visually-hidden">Select message notification</span></label>
                                            </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="px-2 fs-15">
                                            <div className="form-check notification-check">
                                                ...
                                                <label className="form-check-label" htmlFor="messages-notification-check04"><span className="visually-hidden">Select message notification</span></label>
                                            </div>
                                    </div>
                                </div>
                            </div>
