                                    ...
                                    <div className="p-2 mt-4">
                                        <form action="#">
                                            ...
                                            <div className="mt-4 text-center">
                                                ...
                                                <div>
                                                    <Button aria-label="Sign in with Facebook" title="Sign in with Facebook" color="primary" className="btn-icon"><i className="ri-facebook-fill fs-16"></i></Button>{" "}
                                                    <Button aria-label="Sign in with Google" title="Sign in with Google" color="danger" className="btn-icon"><i className="ri-google-fill fs-16"></i></Button>{" "}
                                                    <Button aria-label="Sign in with GitHub" title="Sign in with GitHub" color="dark" className="btn-icon"><i className="ri-github-fill fs-16"></i></Button>{" "}
