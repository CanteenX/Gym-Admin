 ...
 * @param {Object} data - Email to data
 * @returns {Promise}
 */
export const createEmailTo = async (data) => {
    return api.post(ENDPOINTS.EMAIL_TO.BASE, data);
};
...
export const getAllEmailTo = async () => {
    return api.get(ENDPOINTS.EMAIL_TO.BASE);
};

/**
 * Get email to by ID
 * @param {string} id - Email to ID
 * @returns {Promise}
 */
export const getEmailToById = async (id) => {
    return api.get(ENDPOINTS.EMAIL_TO.BY_ID(id));
};

/**
 * Update email to
 * @param {string} id - Email to ID
 * @param {Object} data - Updated email to data
 * @returns {Promise}
 */
export const updateEmailTo = async (id, data) => {
    return api.put(ENDPOINTS.EMAIL_TO.BY_ID(id), data);
};
 ...
 * @returns {Promise}
 */
export const deleteEmailTo = async (id) => {
    return api.delete(ENDPOINTS.EMAIL_TO.BY_ID(id));
};

/**
 * Search email to with filters
 * @param {Object} params - Search parameters
 * @returns {Promise}
 */
export const searchEmailTo = async (params) => {
    return api.post(ENDPOINTS.EMAIL_TO.SEARCH, params);
};
